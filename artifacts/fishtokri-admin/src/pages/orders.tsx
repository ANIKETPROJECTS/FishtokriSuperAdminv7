...
function InvoiceModal({ order, onClose }: { order: any; onClose: () => void }) {
  ...
  const handlePrint = async () => {
    ...
    const upiTxnRow = order.upiTransactionId ? `<div style="margin:6px 0 0;font-size:14px;color:#555;"><b>UPI Txn ID:</b> <span style="font-family:monospace;">${order.upiTransactionId}</span></div>` : "";
